This policy describes how personal data of users who browse **pablothegarden.com** and interact with its services is processed, pursuant to Regulation (EU) 2016/679 ("GDPR") and Italian Legislative Decree 196/2003 as amended.
...
- **Contact form messages**: kept for the time needed to handle the request and, in any case, for a maximum of **24 months**, unless otherwise required by law.
- **Technical logs**: kept only for the time strictly necessary for security and functioning purposes.

## Your rights

As a data subject you may exercise at any time the rights set out in Articles 15-22 GDPR:
...
To exercise your rights, write to **pablothegarden@gmail.com**.

You also have the right to **lodge a complaint with the Italian Data Protection Authority** (Garante per la protezione dei dati personali, [www.garanteprivacy.it](https://www.garanteprivacy.it)).

## Nature of the provision

Providing data via the contact form is optional, but necessary for us to respond: without it we cannot follow up on your request.
...
We reserve the right to update this policy. The current version is always published on this page, with the date of the last update indicated.
