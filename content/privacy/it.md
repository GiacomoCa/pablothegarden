La presente informativa descrive le modalità di trattamento dei dati personali degli utenti che consultano il sito **pablothegarden.com** e che interagiscono con i suoi servizi, ai sensi del Regolamento (UE) 2016/679 ("GDPR") e del D.lgs. 196/2003 e successive modifiche.
...
- **Messaggi del modulo di contatto**: conservati per il tempo necessario a gestire la richiesta e, comunque, per un periodo massimo di **24 mesi**, salvo diversi obblighi di legge.
- **Log tecnici**: conservati per il tempo strettamente necessario alle finalità di sicurezza e funzionamento.
...
Per esercitare i tuoi diritti scrivi a **pablothegarden@gmail.com**.

Hai inoltre il diritto di proporre **reclamo all'Autorità Garante per la protezione dei dati personali** ([www.garanteprivacy.it](https://www.garanteprivacy.it)).

## Natura del conferimento

Il conferimento dei dati tramite il modulo di contatto è facoltativo, ma necessario per poterti rispondere: in mancanza non potremo dare seguito alla tua richiesta.
...
Ci riserviamo di aggiornare la presente informativa. La versione vigente è sempre pubblicata su questa pagina, con l'indicazione della data di ultimo aggiornamento.
